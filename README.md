...
- [Obsidian CLI Plugins](https://github.com/DXShelley/obsidian-cli-plugins-skill) - Obsidian vault automation for journal records, Tasks todos, project notes, attachments, plugin commands, safe reads, and Git-backed sync.
