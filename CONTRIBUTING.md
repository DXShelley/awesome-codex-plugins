...
```bash
pipx install --force "plugin-scanner==2.0.902"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `ccd61b4acbdf0c42dae5289ce7cae1ab0ffc04dad743869127052f5b2310494f`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.902"
