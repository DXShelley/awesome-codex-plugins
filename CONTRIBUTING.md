...
```bash
pipx install --force "plugin-scanner==2.0.951"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `f488305cc64d7de0522351876e58e2f2c3e3a8dfd0ecbfb6dc783c369c87f870`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.951"
