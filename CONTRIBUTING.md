...
```bash
pipx install --force "plugin-scanner==2.0.938"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `cb9469964e372aba59bec506d1c44a12b5c06eea12cdac185ec9dd12e173dee8`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.938"
