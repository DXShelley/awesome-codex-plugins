...
```bash
pipx install --force "plugin-scanner==2.0.893"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `cc03767fce145f53241f9303fd902f8725880a3de44718c643e4a9a93ef0b188`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.893"
