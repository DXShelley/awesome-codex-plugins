...
```bash
pipx install --force "plugin-scanner==2.0.856"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `43959f8610a328568ccc2ab72d3b0dd56659940d973adaec82606f829f761534`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.856"
