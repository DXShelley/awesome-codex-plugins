...
```bash
pipx install --force "plugin-scanner==2.0.916"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `468fe5e22a94752f9e7fce6d20fe94615989f02b9e7f8ccce143702c0e427c86`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.916"
